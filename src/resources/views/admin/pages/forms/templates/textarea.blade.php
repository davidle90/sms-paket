<div class="element" data-unique-id="{{$i}}">
	...
	<input class="element-list-element-id" type="hidden" name="section[{{$y}}][element][{{$i}}][list_element_id]" value="{{$element->list_element_id or '4'}}" />
	...
	<span class="element-drag">
		<b>Fråga <span class="element-number">{{ $i+1 }}</span> - Textarea</b>
	...
	<div class="element-view">
		<div class="form-group">
			...
			<textarea type="text" class="form-control" rows="3" disabled></textarea>
		</div>
	</div>
	...
	<div class="element-options">
		...
		<!-- Modal -->
		<div class="form-element-modal modal fade" data-element="textarea" data-id="{{ $i }}" id="ElementSettingsModal_{{$i}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header danger">
						<h5 class="modal-title" id="exampleModalLongTitle">
							Inställningar fär textarea
						</h5>
					...
					<div class="modal-body">
						...
						<p class="alert alert-info">
							Textarea eller textruta ger möjlighet för användaren att skriva ett svar på flera rader. Använd textarea när det förväntade svaret kan bli långt.
						</p>
