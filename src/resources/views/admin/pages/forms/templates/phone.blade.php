<div class="element" data-unique-id="{{$i}}">
	...
	<input type="hidden" name="element[{{$i}}][list_element_id]" value="{{$element->list_element_id ?? '6'}}" />
	...
	<div class="form-group">
		...
		<input class="form-control" type="text" name="element[{{$i}}][label]" value="{{$element->label ?? 'What is your phone number?'}}" />
	</div>
	<div class="form-group">
